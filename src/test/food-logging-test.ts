...
function simulateOriginalError() {
  ...
  console.log('{"code":"22P02","details":null,"hint":null,"message":"invalid input syntax for type uuid: \\"potato_1\\"}');
  console.log('This error is now fixed by converting food names to proper UUIDs before insertion.\n');
}
...
if (typeof window !== 'undefined') {
  ...
  console.log('Food logging tests loaded. Run testFoodLogging() to test the fix.');
} else {
  // Node environment
